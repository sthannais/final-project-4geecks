	...
	return (
		<div className="row gx-0">
			<div className="sidebar bg-success col-md-2 p-3">
				...
				>
					<span className="sidebar-title">Municipality</span>
				</a>
				<hr />
				<ul className="sidebar-links nav flex-column mb-auto">
					<NavLink to="/user/muni/map">Map</NavLink>
					<NavLink to="/user/muni/list">List</NavLink>
				</ul>
				<hr />
				<div className="dropdown">
					...
					>
						<NavLink className="dropdown-item" to="/user/muni/profile">
							Profile
						</NavLink>
						<NavLink className="dropdown-item" to="/user/muni/settings">
							Settings
						</NavLink>
						<li>
